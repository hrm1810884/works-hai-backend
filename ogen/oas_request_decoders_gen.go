...
func (s *Server) decodeHumanDrawingPostRequest(r *http.Request) (
	...
	case ct == "multipart/form-data":
		...
		var request HumanDrawingPostReq
		{
			if err := func() error {
...
func (s *Server) decodeSavedURLPostRequest(r *http.Request) (
	req *SavedURLPostReq,
	close func() error,
	rerr error,
) {
